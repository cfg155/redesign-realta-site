...
function productSection() {
  ...
  function productTransition() {
    var arrowIndex = this.classList.contains('arrow-right') ? ++count : --count;
    setData(arrowIndex);
  }
