...
<head>
    ...
    <link rel="stylesheet" href="../../css/detailBlog.css" class="test">
                ...
                <div class="content pt-4">
                    <div class="content__blog row">
                        ...
                        <div class="content__blog__main col-xl-8 col-lg-8">
                            <h4 class="title py-3 book-text"><?= $blogData['title'] ?></h4>
                            <div class="info d-flex justify-content-between">
                                <span class="info__published-by">By <?= $blogData['created_by'] ?></span>
                                <div class="info__time d-flex">
                                    <div class="info__date d-flex align-items-center me-4">
                                        ...
                                        <span class="info__date--txt"><?= $blogData['created_date'] ?></span>
                                    </div>
                                    <div class="info__read-time d-flex align-items-center">
                                        ...
                                        <span class="info__read-time--txt"><?= $blogData['min_read'] ?> mins</span>
                                    </div>
                                </div>
                            ...
                            <div class="body">
                                <div class="body__text">
                                    <!-- <img src="../../assets/<? //= $blogData['img_name'] 
                                                                ?>" style="width: 50%; float: left; margin-right: 20px;margin-bottom: 10px;"> -->
                                    <p class="text-justify"><?= $blogData['fulltext'] ?></p>
                                </div>
                            </div>
                        </div>
