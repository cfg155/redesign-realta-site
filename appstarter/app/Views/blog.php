        ...
        <div class="container w-75 m-auto">
            <div class="content">
                ...
                <div class="content__container row">
                    <!-- Main Content -->
                    <div class="col-md-10">
                        <div class="content__container__top d-flex align-items-center mb-5">
                            <div class="left">
                                <img src=" assets/Real Violet Air Sterilizer - PT Realta Chakradarma.png">
                            </div>

                            <div class="right py-2 px-4">
                        ...
                        <div class="content__container__body">
                            <div class="row">
                                <div class="col-md-6 my-4">
                                    <div class="c-card">
                                        <img src="assets/Cue Card - Bandung Golf Gathering 2021.png" alt="">
                                        <h4>Lorem Ipsum</h4>
                                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, rem dicta! Expedita, mollitia at odit dolorum temporibus delectus quo eum!</p>
                                        <div class="footer d-flex justify-content-between">
                                            <div class="date d-flex align-items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18.75" height="20" viewBox="0 0 18.75 20" class="me-2">
                                                    <defs>
                                ...
                                <div class="col-md-6 my-4">
                                    <div class="c-card">
                                        <img src="assets/Cue Card - Bandung Golf Gathering 2021.png">
                                        <h4>Lorem Ipsum</h4>
                                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, rem dicta! Expedita, mollitia at odit dolorum temporibus delectus quo eum!</p>
                                        <div class="footer d-flex justify-content-between">
                                            <div class="date d-flex align-items-center">
                    ...
                    <!-- Side Panel -->
                    <div class="col-md-2">This is side</div>
                </div>
            </div>
        </div>
    </div>
